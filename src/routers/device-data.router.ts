...
deviceDataRouter.route('/:d_id')
    .post(AccessControl.rolesOrDeviceOwner(['superadmin', 'admin']), createDeviceDataHandler)
    .delete(AccessControl.rolesOrDeviceOwner(['superadmin', 'admin']), deleteDeviceDataHandler);
